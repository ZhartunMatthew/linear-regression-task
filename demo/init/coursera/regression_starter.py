...
def compute_linear_regression():
    ...
    print('For computed result for theta [0, 0]: %.4f' % lr.compute_cost_function(x_data, y_data, [0, 0]))
    print('For theta [-1, 2] cost function result something like 54.5')
    print('For computed result for theta [-1, 2]: %.4f' % lr.compute_cost_function(x_data, y_data, [-1, 2]))
